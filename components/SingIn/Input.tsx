...
export default function Input({
  ...
  return (
    <div className="w-full flex flex-col gap-2 relative">
      ...
      <input
        disabled={loading}
        className={`w-full px-6 py-[14px] dark:bg-background bg-white outline outline-1 outline-foreground/20 rounded-md focus:outline-foreground/80 transition-all ${
